...
import { EncountersUberList } from '../EncounterUber';
import { NotificationPage } from '../NotificationPage';
import { OrganizationsUberList } from '../OrganizationsUber';
import { DocumentPrint } from '../PatientDetails/DocumentPrint';
import { PatientResourceListExample } from '../PatientResourceListExample';
import { PractitionerUberList } from '../PractitionerUber';
import { ProceduresUberList } from '../ProcedureUber';
            ...
            <Route
                ...
                element={
                    <BaseLayout>
                        <Routes>
                            {extra}
                            <Route path="/encounters" element={<EncountersUberList />} />
                            ...
                            <Route path="/practitioners" element={<PractitionerUberList />} />
                            <Route path="/organizations" element={<OrganizationsUberList />} />
                            <Route path="/practitioners/:id/*" element={<PractitionerDetails />} />
                            <Route path="/questionnaires" element={<QuestionnaireList />} />
                            <Route path="/procedures" element={<ProceduresUberList />} />
